...
if(
        ...
        //Serial.println("calling pwm attachPin");
        pwm.attachPin(this->pinNumber,REFRESH_CPS, this->timer_width, this->servoChannel );   // GPIO pin assigned to channel
...
void Servo::writeMicroseconds(int value)
{
    ...
    if (this->attached())   // ensure channel is valid
    {
        ...
        this->ticks = value;
        // do the actual write
        //Serial.println("Ticks "+String(this->ticks));
